...
describe Gitlab::Git::Blob do
  ...
  context ".blame" do
    it do
      blob_blame = Gitlab::Git::Blob.blame(repository,'570e7b2abdd848b95f2f578043fc23bd6f6fd24d','CONTRIBUTING.md')
      blob_blame.first.first.should be_kind_of Gitlab::Git::Commit
      blob_blame.first.last.first.should eq('# Contribute to GitLab')
    end
  end
  describe :find do
