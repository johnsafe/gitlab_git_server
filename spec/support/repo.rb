module SeedRepo
  module Repo
    HEAD = "master"
    BRANCHES = ["feature", "fix", "master","fix-blob-path","fix-existing-submodule-dir","fix-mode","test_merge_diff","test_merge_same"].sort
    TAGS = ["v1.0.0", 'v1.1.0', 'v1.2.0', 'v1.2.1']
    DEFAULT_PATCH_PATH = Gitlab::Git::Server::DEFAULT_PATCH_PATH
  end
end
